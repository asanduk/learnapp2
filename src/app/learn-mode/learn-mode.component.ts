...
export class LearnModeComponent implements OnInit {
  ...
  showNextQuestion(): void {
    // İleri gitme işlemlerini gerçekleştir
    this.currentQuestionIndex++;
    this.showCorrectAnswers = false;
  }

  showPreviousQuestion(): void {
    // Geri gitme işlemlerini gerçekleştir
    this.currentQuestionIndex--;
    this.showCorrectAnswers = false;
  }
  ...
  questions: any[] = [
    ...
    },
    {
      ...
      "qtyp": "mc",
      "qtxt": [
        "In order to display all currently mounted filesystems,",
        " which of the following commands could be used? (Choose two.)",
      ],
      "qanswers": [
        {
          "txt": [
    ...
    },
    {
      ...
      "qinfo": [
        ...
        "Entering a runlevel, first all Kxx... scripts will be called ",
        "with first parameter \"stop\" to stop the service.",
        "Then all Sxx... script will be called",
        "with first parameter \"start\" to start the service",
        " /etc/rc1.d/K01apache2",
